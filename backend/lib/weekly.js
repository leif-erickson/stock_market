...
function formatWeeklyEdgeReport({
  ...
  const lines = [
    ...
    '• *AMT map:* 15m OR → initial_balance; VWAP → value; rvol → participation. SMC/VSA are journal tags only (not confirms). Orderflow parked. Gann/Tori are swing books, not 5m facets.',
